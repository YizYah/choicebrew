...
import {ChoicesGenerator} from '../types/functionTypes'
...
export const getValue = (answers: any) => answers[menuQuestionName].value
export const setFlow = (answers: any, flowValue: FlowType) => {
  answers[menuQuestionName].flow = flowValue
}
